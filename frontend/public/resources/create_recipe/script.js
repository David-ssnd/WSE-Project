  ...
  newStep.innerHTML = `
      <div class="food-image">
          <div class="step-img-container">
              <img class="image-preview" alt="Image Preview" style="display: none;">
          </div>
          <button class="btn upload-btn" type="button">Upload Image</button>
          <input name="step-image[]" type="file" class="create-recipe-file-input" accept="image/*" style="display: none;">
      </div>
      <div class="step-info">
          <h3>Step ${index}</h3>
